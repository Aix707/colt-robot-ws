...
1. 安装ROS(indigo/Ubuntu 20.04). [安装步骤](http://wiki.ros.org/noetic/Installation/Ubuntu)
2. 配置好开发环境. [配置方法](http://wiki.ros.org/ROS/Tutorials/InstallingandConfiguringROSEnvironment)
3. 安装依赖项:
```
cd ~/catkin_ws/src/wpv4_bringup
cd scripts
...
```
cd ~/catkin_ws/src/
git clone https://gitee.com/ustb-6/wpv4-ustb.git
```
5. 设置设备端口
```
cd ~/catkin_ws/src/wpv4_bringup
